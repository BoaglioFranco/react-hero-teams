...
export type HeroTeamArray =  [[Hero | null, Hero | null, Hero | null ], [Hero | null, Hero | null, Hero | null ]]
...
export const TeamContextProvider: React.FC<{}> = (props) => {
  const [heroTeam, dispatch] = useReducer(teamReducer, [[null, null, null], [null, null, null]]);
